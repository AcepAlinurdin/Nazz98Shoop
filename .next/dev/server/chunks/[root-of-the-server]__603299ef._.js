...
async function POST(req) {
    try {
        ...
        let title = $('meta[property="og:title"]').attr('content') || $('meta[name="twitter:title"]').attr('content') || $('title').text() || $('h1').first().text();
        let image = $('meta[property="og:image"]').attr('content') || $('meta[name="twitter:image"]').attr('content') || $('link[rel="image_src"]').attr('href') || $('img').first().attr('src');
        // Clean up title
        if (title) {
        ...
        if (!title && !image) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$next$2d$app$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Could not extract data. Shopee might be blocking the request.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__603299ef._.js.map